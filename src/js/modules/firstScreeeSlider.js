const firstScreenSlider = () => {
  const slides = document.querySelectorAll('.first-screen__slide'),
        prev = document.querySelector('.first-screen > .slick-prev'),
        next = document.querySelector('.first-screen > .slick-next'),
        dots = document.querySelectorAll('.first-screen > .slick-dots > ul > li');
  let index = 0;
  ...
  let slider = document.querySelector('.first-screen > .first-screen__slide-list');
  let touchStartX = 0;
  let touchEndX = 0;
